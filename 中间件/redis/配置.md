...
```sh
docker run -d -p 7729:6379 --name redis -v /opt/usr/redis/redis.conf:/etc/redis/redis.conf -v /opt/usr/redis/data:/data --restart=always redis:6.0 --appendonly yes --requirepass WzF3AT2pmwYkBFfM8BKHYZG2ZEQ8QnrXjmKjpk
```
